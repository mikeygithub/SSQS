  ...
  <div id="fund">
    <div id="funtop">
      <table width="1083" height="37" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="68" align="left" valign="middle">功能栏：</td><td width="517" align="center">查询成绩&nbsp;<input type="text" name="lookup1" value="输入学号查询"><input type="submit" value="查询"/></td>
          <td width="498" align="center" valign="middle">查询成绩&nbsp;
      ...
      <div id="m11">
        <table width="100%" height="86" border="0" align="left" cellpadding="1" cellspacing="1">
          <tr>
            ...
            <td width="102" align="center" valign="middle" nowrap="nowrap">MYSQL</td>
            <td width="59" align="center" valign="middle" nowrap="nowrap">C</td>
